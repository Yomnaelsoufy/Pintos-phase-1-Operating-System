...
// static struct thread * IDEL_THREAD;
...
struct thread
  {
    ...
    struct thread *thread_that_I_waiting_on;
    struct list threads_waiting_on_me_elems;
    struct list_elem threads_waiting_on_me_elem;
  };
