...
timer_sleep (int64_t ticks)
{
  ...
  // thread will wait at blocked list until go to ready list
  int life_time = start + ticks;
  struct thread *t = thread_current();
  t->wake_up_time = life_time;
  ...
  list_insert_ordered(&block_list,&t->elem,&get_max_with_timer,NULL);
